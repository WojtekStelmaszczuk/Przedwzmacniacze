    ...
    let All_tracks = [
       {
         name: "Apollo x8",
         path: "PreampTracks/Elektryk/Shure sm57 Clean.wav",
         img_producent: "MicPictures/Preamp/Shure_SM57.jpg",
       },
       {
         name: "Helios Type 69",
         path: "PreampTracks/Elektryk/Shure sm57 Helios.wav",
         img_producent: "MicPictures/Preamp/Shure_SM57.jpg",
       },
       {
         name: "V76",
         path: "PreampTracks/Elektryk/Shure sm57 V76.wav",
         img_producent: "MicPictures/Preamp/Shure_SM57.jpg",
       },
       {
         name: "UA-610 A",
         path: "PreampTracks/Elektryk/Shure sm57 610A.wav",
         img_producent: "MicPictures/Preamp/Shure_SM57.jpg",
       },
       {
         name: "UA-610 B",
         path: "PreampTracks/Elektryk/Shure sm57 610B.wav",
         img_producent: "MicPictures/Preamp/Shure_SM57.jpg",
       },
       {
         name: "Avalon VT-737sp",
         path: "PreampTracks/Elektryk/Shure sm57 Avalon.wav",
         img_producent: "MicPictures/Preamp/Shure_SM57.jpg",
       }
    ];
