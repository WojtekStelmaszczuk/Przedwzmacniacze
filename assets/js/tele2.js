    ...
    let All_tracks = [
       {
         name: "Apollo x4",
         path: "PreampTracks/Fortepian/UAD_Blumlein_Fortepian_12.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       },
       {
         name: "Helios Type 69",
         path: "PreampTracks/Fortepian/Helios_Blumlein_Fortepian_12.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       },
       {
         name: "V76",
         path: "PreampTracks/Fortepian/V76_Blumlein_Fortepian_1.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       },
       {
         name: "UA-610 A",
         path: "PreampTracks/Fortepian/610A_Blumlein_Fortepian_12.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       },
       {
         name: "UA-610 B",
         path: "PreampTracks/Fortepian/610B_Blumlein_Fortepian_12.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       },
       {
         name: "Avalon VT-737sp",
         path: "PreampTracks/Fortepian/Avalon_Blumlein_Fortepian_12.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       },
		{
         name: "Century Tube CS",
         path: "PreampTracks/Fortepian/CS_Blumlein_Fortepian_12.wav",
         img_producent: "MicPictures/Preamp/AKG_C414_XLS.jpg",
       }
    ];
